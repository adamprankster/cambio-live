...
export const lessons=[
 ...
 step('You’re ready to play','Your round: 2 − 5 bonus = −3. Previous totals of 12 and 8 become 9 and 29. Wrong or tied calls add +10 by default. At the score limit (default 50), the lowest total wins; ties share the win.','done','done','Practice complete. Try any lesson again, or close practice and start a real table.') ]}
];
