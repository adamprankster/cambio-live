...
for(const f of ['index.html','app.js','styles.css','config.js','store-config.js','vendor/supabase.js','vendor/native.js','fonts/dm-sans.woff2','fonts/manrope.woff2'])assert.equal(hash('public/'+f),hash('ios/App/App/public/'+f),'iOS assets out of sync: '+f);
